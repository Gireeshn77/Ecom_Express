...
import com.Ecom_Express.utilities.LoginRepository;

public class TC_Login_002 extends BaseClass {

	@Test(dataProvider = "agentIds", dataProviderClass = DBDataProvider.class)
	public void DataTest_dp(int agentId) throws Exception {

		LoginData login = getLoginData_dp(agentId);
	...
	public void DataTest(int agentId) throws Exception {
		...
		LoginData login = repo.getLoginData(agentId);
